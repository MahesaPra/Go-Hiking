...
<header class="masthead">
	<div class="container">
		...
		<a class="btn btn-primary btn-xl text-uppercase" href="#home">Lihat Gunung</a>
	</div>
</header>
...
<section class="page-section bg-dark" id="home">
	<div class="container">
		<h2 class="text-center">Gunung</h2>
			...
			<div class="col-md-4 p-4 ">
				<div class="card w-100 rounded-0">
					...
					<div class="w-100 d-flex justify-content-end">
						<a href="./?page=view_room&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning">Lihat Gunung <i class="fa fa-arrow-right"></i></a>
					</div>
					</div>
				</div>
			</div>
	...
	<div class="d-flex w-100 justify-content-end">
		<a href="./?page=rooms" class="btn btn-flat btn-warning mr-4">Lihat Gunung Lain <i class="fa fa-arrow-right"></i></a>
	</div>
	</div>
</section>
<!-- About-->
<section class="page-section" id="about">
	<div class="container">
		<div class="text-center">
			<h2 class="section-heading text-uppercase">Peraturan Umum</h2>
		</div>
		<div>
