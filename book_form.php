        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <table class="table">
                    ...
                    <tr class="border-top">
                        <td>Total <input type="hidden" name="room_rate_sub" value="0"></td>
                        <td class="text-right" id="room_sub_total"><?php echo number_format($price) ?></td>
                    </tr>
                    <tr>
                        <td>Biaya Penanganan <input type="hidden" name="accommodation_sub" value="0"></td>
...
<script>
    ...
    function calc_total(){
        ...
        var room_rate = $('#room_rate').text()
            ...
            room_rate_sub = parseFloat(room_rate) 
